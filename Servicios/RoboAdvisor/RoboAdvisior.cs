...
namespace TheTrader.Controles
{
    class RoboAdvisior
    {
        ...
        public void EjecutarProcesadoDeRoboAdvisor() {
            ...
            Console.WriteLine("Cargados un total de "+ valoresPrecarga.AccionInvestingLista.Count+" acciones de investing");
            foreach (AccionInvesting accion in valoresPrecarga.AccionInvestingLista)
            {
                ...
                //Console.WriteLine("Procesada acción: " + accionCargada.Nombre);
            }
        }
